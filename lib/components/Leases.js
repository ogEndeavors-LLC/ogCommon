...
const Leases = () => {
  ...
  useEffect(() => {
    const filtered = leases.filter(lease => lease.LeaseID.toLowerCase().includes(searchTerm.toLowerCase()) || lease.LeaseName.toLowerCase().includes(searchTerm.toLowerCase()) || lease.PumperID.toLowerCase().includes(searchTerm.toLowerCase()) || lease.RRC.toLowerCase().includes(searchTerm.toLowerCase()));
...
const EditLeaseModal = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-semibold"
  }, "Well ", well.WellID || index + 1), /*#__PURE__*/React.createElement(FontAwesomeIcon, {
    ...
    className: "block text-sm font-medium text-gray-700"
  }, "RRCLeaseID"), /*#__PURE__*/React.createElement("input", {
    id: `RRCLeaseID-${index}`,
    name: "RRCLeaseID",
    type: "text",
    maxLength: 6,
